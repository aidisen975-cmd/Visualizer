...
v0.2.3 基于 v0.2.2 做交互与排版修正，不进入 Local Zoom / Inset / Cursor / Annotation / Formula 等 V0.3.0 功能。

### V0.2.3 已完成

- Figure Series 编辑区支持 Ctrl/Cmd、多选、Shift 连选、Ctrl/Cmd+A
- Data Selection 与 Figure Series Selection 交互规则统一，但状态作用域独立
- Series 长名称显示优化，Display Name / Original Name 清晰分层
- Figure Title / Axis Title / Tick Label 使用文字测量驱动 Auto Layout
- 大字号不再溢出 Figure
...
未做（完整 V1 / 后续）：Formula、MAE/RMSE、Results、Split、Local Zoom、Inset、Annotation 编辑器、Cursor / Data Inspector、Undo、Dual Y Axis、轴联动、布局锁定、工程缩略图、Electron/Tauri、Heatmap、3D。
